...
;;;	����������������������������������������������������������1��9 
;;;	����0������������������������������������������������������
;;;	(Emacs-19��������windows����������������������frame������������)��
;;;
;;;	  win:startup-with-window �� .emacs ����������������������������
;;;	����������������1����������������������������������������������
;;;	������ C-c C-w 1 ������������������������1����������������������
;;;	������
;;;
...
;;;
;;;	  ����������������������������������C-x C���� Emacs ������������
;;;	�� Emacs ���������������� resume-windows (������ C-c C-w C-r r)
;;;	����������������������������������������������������������������
;;;	������������������������������
;;;
;;;����������������������
...
;;;		(setq win:base-key ?`)		;; ` ����������������
;;;		(setq win:max-configs 27)	;; ` �� z ��27����
;;;		(setq win:quick-selection nil)	;; C-c���� ��������������
;;;
;;;	������ ` ������������������ a ����������������������������������
;;;	����C-c C-w ` ��������������������������������������������������
;;;	����������������������������
...
;;;	  windows ��������������������������������������
;;;
;;;	win:switch-prefix	windows.el ��������prefix����
;;;	win:menu-key-stroke	window����menu������(prefix������������)
;;;	win:resume-key-stroke	resume menu ������ (��)
;;;	win:resume-local-key-stroke	local resume menu ������ (��)
;;;	win:switch-task-key-stroke	switch task menu ������ (��)
;;;	win:quick-selection	C-c ���� ������window����������
;;;	win:mode-line-format	window���������� mode-line format
;;;	win:configuration-file	resume file ��������
;;;	win:make-backup-files	resume file ����������������������
;;;	win:buffer-depth-per-win window����buffer-list����������������������
;;;				nil������buffer-list��������������������
...
;;;
;;;	-- ���� mule2 ������������������������������������ --
;;;	win:no-raise-at-save	��window����������������������raise������
...
;;;				'absolute ��������������������������
;;;				'relative ��������������������������������
;;;	win:new-frame-offset-x	������������������������X����������������
;;;	win:new-frame-offset-y	������������������������Y����������������
;;;	win:resumed-frame-offset-x ����������������������X����������������
;;;				fvwm�������������� BoundaryWidth ������
;;;				������������������3������������������
;;;	win:resumed-frame-offset-y ����������������������Y����������������
;;;	win:mouse-position	������������������������������������
;;;				'(x y) ������������������
